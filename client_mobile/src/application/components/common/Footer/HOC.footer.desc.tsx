			...
			<div className="footer-desc">
				<div className="container">
					<div className="footer-desc_box">
						<div>
							<img
								src={require('assets/images/icons/footlogo.png')}
								alt="Старик Хинкалыч"
							/>
						</div>
						...
						<div className="foot_menu">
							...
							<a
								href="https://starikkhinkalich.ru/delivery"
								className="foot_menu-item"
							>
								Условия доставки
							</a>
							<NavLink
								to="/docs/СтарикХинкалычКалорийностьблюд.pdf"
								target="_blank"
								className="foot_menu-item"
							>
							...
							<a
								href="https://docs.google.com/forms/d/e/1FAIpQLScF_kqRIOC4YtZGJnravy94pIEbzlmW4MM3IWhR_tBGLqcQ0g/viewform?pli=1"
								className="foot_menu-item"
							>
								Вакансии
							</a>
							<a
								href="https://франшиза.хинкалыч.рф/"
								className="foot_menu-item"
							>
								Франшиза
							</a>
						...
						<div className="foot_info">
							...
							<div className="foot_social-phone">
								{point && point.info.phone}
							</div>
							<div className="foot_social-social">
								<a href="https://t.me/s/starikhinkalych">
									<img
										src={require('assets/images/icons/telegramfoot.png')}
										alt="tl"
									/>
								</a>
								<a href="https://vk.com/starikhinkalych">
									<img
										src={require('assets/images/icons/footvk.png')}
										alt="vk"
									/>
								</a>
							</div>
					...
					<div className="footsub">
						...
						>
							<path
								fillRule="evenodd"
								clipRule="evenodd"
								d="M-6.9938e-07 16L0 -4.37112e-08L1 0L0.999999 16L-6.9938e-07 16Z"
								fill="white"
							/>
						</svg>
