	...
	return (
		<>
...

			{
				...
				<ModalCard setIsOpened={() => navigate(-1)} theme={null} styles="login-container_modal" >
					<OfferAuth />
				</ModalCard>
			}
			{
