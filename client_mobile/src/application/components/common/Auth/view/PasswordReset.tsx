						...
						<div className="auth-center auth-content unauthorized__content">
							...
							<div className="auth-content__inputs">
								...
								<div className="auth-content__inputs-sms">
									<PinInput autoSelect={true} length={4} onComplete={(value, index) => handlerCodeSend(value)} />
								</div>
								{
									errorcode &&
							...
							<div className="auth-content__inputs">
								...
								{
						error && 
						<span className="error">Произошла ошибка, аккаунт не найден</span>
					}
								<div className="auth-footer">
								<button className="btn btn-md btn-red">Изменить пароль</button>
