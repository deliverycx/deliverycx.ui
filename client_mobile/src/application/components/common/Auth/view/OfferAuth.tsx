							...
							<form onSubmit={formik.handleSubmit}>
								<div className="auth-center auth-content unauthorized__content">
									...
									<div className="auth-footer">
										...
										<div className="unauthorized__content-text">
											Если у вас нет аккаунта, <a href={ROUTE_APP.AUTH.REGISTER} className="auth-footer__link"><span style={{ color: "#8D191D" }}>Зарегистрируйтесь</span></a>
										</div>
						...
						<div className="top-bar__left">
							<div className="top-bar__icon" onClick={()=> navigate(-1)}>
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M18.3 5.70875C17.91 5.31875 17.28 5.31875 16.89 5.70875L12 10.5888L7.10997 5.69875C6.71997 5.30875 6.08997 5.30875 5.69997 5.69875C5.30997 6.08875 5.30997 6.71875 5.69997 7.10875L10.59 11.9988L5.69997 16.8887C5.30997 17.2787 5.30997 17.9087 5.69997 18.2987C6.08997 18.6887 6.71997 18.6887 7.10997 18.2987L12 13.4087L16.89 18.2987C17.28 18.6887 17.91 18.6887 18.3 18.2987C18.69 17.9087 18.69 17.2787 18.3 16.8887L13.41 11.9988L18.3 7.10875C18.68 6.72875 18.68 6.08875 18.3 5.70875Z" fill="#8D191D" />
								</svg>
							</div>
							<h3>Авторизация</h3>
						...
						<FormikProvider value={formik}>
							<form onSubmit={formik.handleSubmit}>
								<div className="auth-center auth-content unauthorized__content">
									...
									<div className="auth-footer">
										<button className="auth-button btn btn-md btn-red">Войти</button>
										<div className="unauthorized__content-text">
											Если у вас нет аккаунта, <a href={ROUTE_APP.AUTH.REGISTER} className="auth-footer__link"><span style={{ color: "#8D191D" }}>Зарегистрируйтесь</span></a>
										</div>
										<a className="auth-footer__link">
