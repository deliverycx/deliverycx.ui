        ...
        <div className="notification_modal notification_city">
          <div className="notification_modal-container">
            ...
            <div className="you_city-text">
              Покажем актуальное меню, условия доставки и акции ближайшего к
              тебе ресторана
            </div>
            <div className="notification_city__change">
              <div
                className="notification_city-btn-success"
                onClick={() => appUseCase.youCityNotificate(false)}
              >
                Да, верно
              </div>
              <span
                className="notification_city-swap"
                onClick={() => {
