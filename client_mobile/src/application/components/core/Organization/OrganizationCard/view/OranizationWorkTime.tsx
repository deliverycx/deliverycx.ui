...
const OranizationWorkTime: FC<{ organization: IOrganization & IOrganizationStatus }> = ({ organization }) => {
					...
					<button onClick={() => setModalWork(true)} className="btn btn-mini btn-gray no-drag">
						...
						}
						{
							...
							<svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M5.91327 6.19354L8.49994 8.7802L11.0866 6.19354C11.3466 5.93354 11.7666 5.93354 12.0266 6.19354C12.2866 6.45354 12.2866 6.87354 12.0266 7.13353L8.96661 10.1935C8.70661 10.4535 8.28661 10.4535 8.02661 10.1935L4.96661 7.13353C4.70661 6.87354 4.70661 6.45354 4.96661 6.19354C5.22661 5.9402 5.65327 5.93354 5.91327 6.19354Z" fill="#333333" />
							</svg>
						}
