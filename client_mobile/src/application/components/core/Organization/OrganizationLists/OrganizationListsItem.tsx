...
const OrganizationListsItem: FC<IProps> = ({
  organization,
  setCordPoint,
  setPointIndex,
  set,
  ...
  const CN = cn('orglist_box-item', {
    active: selectOrganization?.id === organization.id,
  });
  return (
    <div className={CN}>
      <div className="orglistitem_geo" onClick={handlerSetCords}></div>
      <div className="orglistitem_point" onClick={handlerSelectPoint}>
        ...
        {organization.timeworkOrganization &&
          organization.timeworkOrganization.typework === 'WORK' && (
        ...
        {organization.timeworkOrganization &&
          organization.timeworkOrganization.typework === 'NOWORK' && (
            <div className="orglistitem_point-time close">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
