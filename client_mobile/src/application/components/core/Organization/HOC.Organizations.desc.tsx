...
const HOCOrganizationsDesc = () => {
  ...
  const { handleBackCity, closeModalDesc, setPointIndex, setPointCords } =
    useCase.handlers;
  ...
  return (
    <>
      {params.pathname === ROUTE_APP.POINT && (
        <>
          <ModalCard
            setIsOpened={() => handleBackCity()}
            theme={null}
            styles="point_modal-desc"
          >
            <div className="modal__wrapper">
              <div className="modal__header-pointdesc">
                <div className="modal__header" onClick={() => handleBackCity()}>
                  <svg
                    className="no-drag"
                ...
                <div className="points-desc_head">
                  ...
                  <div className="points-desc_head-section">
                    <div className="points-desc_map-list">
                      <button
                        className="btn btn-icon btn-tiny btn-red"
                        onClick={() =>
                      ...
                      >
                        {modalOpenedList ? (
                          ...
                          >
                            <path
                              d="M18.3002 5.70875C17.9102 5.31875 17.2802 5.31875 16.8902 5.70875L12.0002 10.5888L7.11022 5.69875C6.72022 5.30875 6.09021 5.30875 5.70021 5.69875C5.31021 6.08875 5.31021 6.71875 5.70021 7.10875L10.5902 11.9988L5.70021 16.8887C5.31021 17.2787 5.31021 17.9087 5.70021 18.2987C6.09021 18.6887 6.72022 18.6887 7.11022 18.2987L12.0002 13.4087L16.8902 18.2987C17.2802 18.6887 17.9102 18.6887 18.3002 18.2987C18.6902 17.9087 18.6902 17.2787 18.3002 16.8887L13.4102 11.9988L18.3002 7.10875C18.6802 6.72875 18.6802 6.08875 18.3002 5.70875Z"
                              fill="white"
                            />
                          </svg>
                        ) : (
                      ...
                      {modalOpenedList && organizations && (
                        <div className="points-desc_list">
                          <HOCOrganizationLists
                            organizations={organizations}
                            setPointIndex={setPointIndex}
                            set={setIsOpenedList}
                            setCord={setPointCords}
                          />
                        </div>
                      )}
                    </div>
