    ...
    <>
      ...
      <div className="modal_desctop addtionalproduct_modal">
        ...
        <div className="addtionalproduct_modal_box-btn">
          <button
            className="addtionalproduct_modal-btn"
            onClick={handlerGoOrder}
          >
            Продолжить
          </button>
        </div>
