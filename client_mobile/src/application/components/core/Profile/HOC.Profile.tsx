        ...
        {profile && user && (
          <div className="profile-content">
            <div className="profile-content__info">
              <h2 className="profile-content__info-name">
                {profile.personal && profile.personal.name ? (
                  profile.personal.name
                ) : (
                  <a href={ROUTE_APP.PROFILE.PROFILE_PERSONAL}>Добавить имя</a>
                )}{' '}
              </h2>
            ...
            <div className="profile-content__list">
              <NavLink
                to={ROUTE_APP.PROFILE.PROFILE_PERSONAL}
                className="profile-content__list-link"
              >
                Личные данные
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <NavLink
                to={ROUTE_APP.PROFILE.PROFILE_ADRESS}
                className="profile-content__list-link"
              >
                Адреса доставки
                <svg
              ...
              <NavLink
                to={ROUTE_APP.PROFILE.PROFILE_ORDERS}
                className="profile-content__list-link"
              >
                Заказы
                <svg
