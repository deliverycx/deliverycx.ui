...
import schema, {
  shemaProfilePersonal,
} from 'application/helpers/validationSchema';
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="personal">
          ...
          <div className="personal-content">
            ...
            <div className="personal-content__items">
              ...
              <div className="form-radio">
                ...
                <div className="form-radio__toggle">
                  <div
                    className="form-radio__toggle__item"
                    onClick={() => formik.setFieldValue('male', 'man')}
                  >
                    <input
                      type="radio"
                      name="male"
                      checked={formik.values.male === 'man'}
                    />
                  ...
                  <div
                    className="form-radio__toggle__item"
                    onClick={() => formik.setFieldValue('male', 'girl')}
                  >
                    <input
                      type="radio"
                      name="male"
                      checked={formik.values.male === 'girl'}
                    />
                    <div className="form-radio__toggle__item-icon">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
            ...
            <label>
              {error && 'Произошла ошибка, попробуйте ещё раз или сообщите нам'}
            </label>
          </div>
...
export default observer(HOCPersonal);
