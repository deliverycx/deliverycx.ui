        ...
        <div className="profile-content__gift">
          ...
          <div className="gift_info">
            <div className="gift_info-box">
              ...
              <span className="gift_info-box-count">
                {balanse.stampsBeforeReward} штамов
              </span>
            </div>
            <div className="gift_info-box">
              <span>подарочная дюжина</span>
              <span className="gift_info-box-count">
                {balanse.numberRewardsUnused} награды
              </span>
            </div>
          </div>
        </div>
