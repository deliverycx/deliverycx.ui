...
const CartYmap = () => {
  ...
  // console.log('stateReduceMap.disclaimer', stateReduceMap.disclaimer);
  // console.log('stateReduceMap.valueMap', stateReduceMap.valueMap);
  console.log('stateReduceMap', stateReduceMap);
  console.log('stateReduceMap.disclaimer', stateReduceMap.disclaimer);
