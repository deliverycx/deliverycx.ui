            ...
            (city || stateReduceMap.valueMap) &&
              <div className="mapsPopup">
                  <div className="justify-between">
                      ...
                      <button disabled={stateReduceMap.cord && !stateReduceMap.cord.length && !stateReduceMap.disclaimer || stateReduceMap.disclaimer} className="mapsPopup__button btn" onClick={hendleMapPopup}>
